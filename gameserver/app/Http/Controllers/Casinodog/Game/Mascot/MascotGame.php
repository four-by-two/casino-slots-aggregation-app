...
class MascotGame extends MascotMain
{
    ...
    public function game_event(Request $request)
    {
        ...
        //we are cloning the request and changing to the minimum bet amount, this because demo balance on mascot is only 100 credits after we parse gameresult, we will map back to original bet
        $request_arrayable = $request->toArray();
