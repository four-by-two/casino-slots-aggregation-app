...
class MascotMain extends GameKernel
{
    ...
    */
    public function modify_game($token_internal, $game_content)
    {
        ...
        $new_api_endpoint = config('casinodog.games.mascot.new_api_endpoint').$token_internal.'/'.$select_session['game_id'].'/play';  // building up the api endpoint we want to receive game events upon
